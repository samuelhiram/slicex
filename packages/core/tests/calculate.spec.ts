...
describe('calculateBalanceAt', () => {
  ...
  it('handles daily recurrence', () => {
    const doc = {
      ...
      title: 'daily',
      items: [
        { id: 'd1', tenantId: 'tenant1', name: 'daily', amount: 10, date: '2026-01-01', recurrence: { frequency: 'DAILY', interval: 1 } }
      ]
    } as any;
  ...
  it('respects recurrence count', () => {
    const doc = {
      ...
      title: 'count',
      items: [
        { id: 'c1', tenantId: 'tenant1', name: 'limited', amount: 7, date: '2026-01-01', recurrence: { frequency: 'WEEKLY', interval: 1, count: 2 } }
      ]
    } as any;
  ...
  it('respects until date for recurrence', () => {
    const doc = {
      ...
      title: 'until',
      items: [
        { id: 'u1', tenantId: 'tenant1', name: 'until', amount: 5, date: '2026-01-01', recurrence: { frequency: 'MONTHLY', interval: 1, until: '2026-03-01' } }
      ]
    } as any;
